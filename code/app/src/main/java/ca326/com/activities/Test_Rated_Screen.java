...
public class Test_Rated_Screen extends AppCompatActivity implements RecyclerView.OnScrollChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test__rated__screen);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest("http://animationdoodle2017.com/video_db.php?page=" + String.valueOf(pageCount),
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Test_Rated_Screen.this, "No More Items Available", Toast.LENGTH_SHORT).show();
                    }
                });
